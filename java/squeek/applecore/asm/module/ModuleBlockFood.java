...
public class ModuleBlockFood implements IClassTransformerModule
{
	...
	public byte[] transform(String name, String transformedName, byte[] basicClass)
	{
		...
		MethodNode methodNode = ASMHelper.findMethodNodeOfClass(classNode, "func_180682_b", "eatCake", ASMHelper.toMethodDescriptor("Z", ASMConstants.WORLD, ASMConstants.BLOCK_POS, ASMConstants.IBLOCKSTATE, ASMConstants.PLAYER));		if (methodNode != null)
		{
